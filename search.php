                    ...
                    <div class="busca">
                        ...
                        ?>
                            ...
                            <div>
                                ...
                                while ($resultadoSQL = mysqli_fetch_array($sql)) {
                                ?>
                                    <div class="row" style="margin-left: 10px;">
                                        <div class="col-sm-1 col-md-1 col-lg-1">
                                            <audio id='<?php echo "audio" . $i; ?>' src="<?php echo $resultadoSQL['file']; ?>"></audio>
                                        ...
                                        <div class="col-sm-2 col-md-2 col-lg-2 fotoArt">
                                            <img src="<?php echo $resultadoSQL['fotoArt']; ?>" style="width: 55px; height: 55px;">
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-6 nomeartista" style="margin-top: 25px; margin-left: 50px;">
                                            <?php echo $resultadoSQL['titulo']; ?>
                                        </div>
                                        <div class="col-sm-2 col-md-2 col-lg-2" style="margin-top: 25px; margin-left: 23px;">
                                            <?php echo $resultadoSQL['duracao']; ?>
                                        </div>
                                    </div>
                            <?php
                                    $i++;
